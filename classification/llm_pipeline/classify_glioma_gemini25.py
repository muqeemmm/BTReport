...
This is the Gemini counterpart of `classify_glioma_groq.py` (and the
previous-generation sibling of `classify_glioma_gemini31.py`). It performs the
...
def main() -> None:
    ...
    output_dir = HERE / f"gemini25_outputs_{args.json_type}" if args.json_type \
        else HERE / "gemini25_outputs"
